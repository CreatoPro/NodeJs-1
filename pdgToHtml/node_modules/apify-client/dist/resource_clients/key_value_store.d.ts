...
export declare type ReturnTypeFromOptions<Options extends KeyValueClientGetRecordOptions> = Options['stream'] extends true ? ReadableStream : Options['buffer'] extends true ? Buffer : JsonValue;
